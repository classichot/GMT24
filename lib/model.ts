...
export const RULES: Rule[] = [
  ...
  },
  {
    ...
    effectiveFrom: "2024-01-01",
    effectiveTo: null,
    source: "GloBE Model Rules Arts. 1.5.3–9.1.3 · Consolidated Commentary 2026 · GIR Sep 2026 / XML v1.0 · Side-by-Side Package January 2026 · Central Record",
    version: "2026.2",
  ...
  },
  {
    ...
    effectiveFrom: "2026-01-01",
    effectiveTo: null,
    source: "OECD GloBE Information Return (September 2026, §36.1 edition rule) · GIR XML Schema v1.0, urn:oecd:ties:globe:v2 (revised schema pending) · June 2026 first-filing guidance",
    version: "2026.9",
    formula: "live snapshot → FilingInfo + GeneralSection (1.3.1.6 SbS election, rule options v/vi) + banded Summary 1.4 + JurisdictionSection (SH options a–k, 2.1.5, Simplified ETR, STISH, CE detail) + UTPRAttribution + dissemination",
    parameters: { namespaceVersion: 2, schemaVersion: "1.0", template: "GIR-2026-09", templateAppliesFromFyStart: "2025-12-31" },
    status: "active",
  },
  {
    id: "OECD-MOCE-513",
