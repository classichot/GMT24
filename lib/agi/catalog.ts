/**
 * GMT24 AGI Mode — Mission Catalog.
 *
 * The catalog is the library of missions the AGI department can run, organised
 * around the four outcomes:
 ...
 *
 * Master Outcome Missions are what users see first; the Mission Director
 * orchestrates the underlying specialist missions automatically as a Single
 * agent, a Team or a Cooperative Swarm (see WorkMode / WORK_MODE_LABEL). No
 * mission lets an LLM post a Pillar Two number — the versioned engine
 * calculates; the department plans, extracts, explains and drafts. Every mission
 * records the rulebook, jurisdiction-law and GIR-schema versions it ran against,
 * because OECD guidance and the GIR structure keep changing (2026 Consolidated
 * Commentary, September 2026 GIR update).
 *
 * Pure data + selectors (no "use client") so it can be imported from server and
 * client components alike.
 */
import type { WorkMode } from "./specialists";
...
export type Outcome = {
  ...
  short: string;
  blurb: string;
  /** AGI area that is the natural home for this outcome. */
  area: string;
};
...
export const MISSION_LIFECYCLE = ["Draft", "Reviewed", "Approved", "Filed", "Locked"] as const;
...
export type MissionCategory = {
  ...
  title: string;
  outcome: OutcomeId;
  /** Default AGI work mode for specialist missions in this category. */
...
export const CATEGORIES: MissionCategory[] = [
  { id: "master", section: 1, code: "OUT", title: "Master Outcome Missions", outcome: "calculate", defaultMode: "team", master: true, blurb: "The missions users see first. The Mission Director orchestrates the underlying specialist missions automatically." },
...
export type Mission = {
  ...
  wow?: string;
  /** Related GMT24 screen (normal mode or an AGI area), when one exists. */
  appHref?: string;
...
const MASTER: Mission[] = [
  ...
  { id: "OUT-03", title: "Complete Annual Pillar Two Calculation", categoryId: "master", outcome: "calculate", mode: "swarm", mvp: true, appHref: "/agi/calculation", output: "Approved GloBE, ETR and top-up tax calculation", orchestrates: ["INC-12", "TAX-12", "ETR-06", "ETR-11"] },
  { id: "OUT-04", title: "Find My Best Elections", categoryId: "master", outcome: "options", mode: "team", mvp: true, appHref: "/agi/options", output: "Ranked elections with tax, compliance and risk impact", orchestrates: ["ELEC-01", "ELEC-02", "ELEC-04", "ELEC-05"] },
  ...
  { id: "OUT-07", title: "Complete Global GIR Filing", categoryId: "master", outcome: "comply", mode: "swarm", mvp: true, appHref: "/agi/reporting", output: "GIR dataset, XML, local filing matrix and approvals", orchestrates: ["FILE-03", "FILE-04", "FILE-07", "FILE-09"] },
  ...
  { id: "OUT-09", title: "Make the Group Audit-Ready", categoryId: "master", outcome: "assure", mode: "swarm", mvp: true, appHref: "/agi/audit-file", output: "Evidence room, position papers and audit defence pack", orchestrates: ["AUD-05", "AUD-07", "AUD-08", "AUD-11"] },
  ...
  { id: "OUT-12", title: "Reperform Existing Adviser Calculation", categoryId: "master", outcome: "calculate", mode: "swarm", appHref: "/agi/calculation", output: "Independent shadow calculation and variance report", orchestrates: ["AUD-03", "AUD-01", "TAX-12"] },
  ...
  { id: "OUT-16", title: "Perform RD Shadow Audit", categoryId: "master", outcome: "assure", mode: "swarm", appHref: "/agi/calculation", output: "Filed-versus-reperformed assessment and tax-at-risk", orchestrates: ["RD-05", "RD-06", "RD-08"] },
];
...
const SPECIALIST: Mission[] = [
  ...
  { id: "DATA-10", categoryId: "data", outcome: "calculate", title: "Run data completeness and quality diagnostics", mvp: true, appHref: "/agi/data" },
  ...
  { id: "ELEC-BON", categoryId: "harbour", outcome: "options", mode: "team", wow: "Best Option Navigator", title: "Best Option Navigator", appHref: "/agi/options", note: "Recommend the best defensible combination of elections and treatments, while showing why rejected options are weaker." },
  ...
  { id: "FILE-09", categoryId: "filing", outcome: "comply", title: "Coordinate preparer, reviewer and signatory approval", appHref: "/agi/approvals" },
  ...
  { id: "AUD-01", categoryId: "audit", outcome: "assure", title: "Run AI Calculation Reviewer", appHref: "/agi/calculation" },
  ...
  { id: "AUD-03", categoryId: "audit", outcome: "assure", wow: "Reported-vs-Shadow Delta Navigator", title: "Run reported-versus-shadow variance analysis", appHref: "/agi/calculation" },
  ...
  { id: "AUD-11", categoryId: "audit", outcome: "assure", wow: "One-Click Audit Defence Pack", title: "Build the jurisdiction audit-defence pack", appHref: "/agi/audit-file" },
  ...
  { id: "ADV-05", categoryId: "advisor", outcome: "comply", title: "Allocate work to adviser specialist teams", appHref: "/agi/team" },
  { id: "ADV-06", categoryId: "advisor", outcome: "assure", title: "Review junior-preparer calculations", appHref: "/agi/calculation" },
...
export function missionMode(m: Mission): WorkMode {
...
export function missionGovernance(m: Mission): MissionGovernance {
  ...
  const agentLead =
    mode === "swarm"
      ? "Cooperative Swarm — jurisdiction & issue agents"
      : mode === "team"
        ? "Mission Director + specialist team"
