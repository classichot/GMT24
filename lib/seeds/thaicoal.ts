 ...
 * explorer. Calendar FY2026, USD presentation. Every name and figure is
 * fictional; the shape is modelled on a Thai energy conglomerate.
 */
const group: Group = {
  id: "thaicoal",
  name: "ThaiCoal PCL",
  ...
  revenueHistory: [
    ...
    { fy: "FY2026", amount: 4_610_000_000 },
  ],
  entities: 96,
  jurisdictions: 11,
  workflow: "Calculated",
...
const financials: Financials[] = [
  { entityId: "TC-UPE", revenue: 1_920_000_000, fanil: 214_000_000, currentTax: 9_500_000, deferredTax: -1_200_000, otherCovered: 0, nonCovered: 620_000, payrollEligible: 48_000_000, employees: 640, tangibleEligible: 212_000_000, cbcrRevenue: 1_920_000_000, cbcrProfit: 214_000_000, cbcrTax: 8_300_000, priorDta: 6_400_000, priorDtl: 3_100_000 },
  { entityId: "TC-TH-PWR", revenue: 428_000_000, fanil: 97_000_000, currentTax: 6_900_000, deferredTax: 400_000, otherCovered: 0, nonCovered: 180_000, payrollEligible: 22_000_000, employees: 310, tangibleEligible: 124_000_000, cbcrRevenue: 428_000_000, cbcrProfit: 97_000_000, cbcrTax: 7_300_000, priorDta: 1_200_000, priorDtl: 2_400_000 },
  { entityId: "TC-TH-NRG", revenue: 162_000_000, fanil: 41_000_000, currentTax: 900_000, deferredTax: 200_000, otherCovered: 0, nonCovered: 90_000, payrollEligible: 9_000_000, employees: 240, tangibleEligible: 262_000_000, cbcrRevenue: 162_000_000, cbcrProfit: 41_000_000, cbcrTax: 1_100_000, priorDta: 400_000, priorDtl: 5_800_000 },
  { entityId: "TC-TH-MIN", revenue: 86_000_000, fanil: 11_000_000, currentTax: 2_200_000, deferredTax: 100_000, otherCovered: 0, nonCovered: 40_000, payrollEligible: 12_000_000, employees: 380, tangibleEligible: 41_000_000, cbcrRevenue: 86_000_000, cbcrProfit: 11_000_000, cbcrTax: 2_300_000, priorDta: 300_000, priorDtl: 600_000 },
  { entityId: "TC-SG-HC", revenue: 1_640_000_000, fanil: 62_000_000, currentTax: 5_800_000, deferredTax: 300_000, otherCovered: 0, nonCovered: 0, payrollEligible: 14_000_000, employees: 95, tangibleEligible: 6_000_000, cbcrRevenue: 1_643_000_000, cbcrProfit: 62_000_000, cbcrTax: 6_100_000, priorDta: 200_000, priorDtl: 900_000 },
  { entityId: "TC-SG-REN", revenue: 3_000_000, fanil: 9_200_000, currentTax: 100_000, deferredTax: 0, otherCovered: 0, nonCovered: 0, payrollEligible: 1_100_000, employees: 8, tangibleEligible: 400_000, cbcrRevenue: 3_000_000, cbcrProfit: 9_200_000, cbcrTax: 100_000, priorDta: 0, priorDtl: 0 },
  { entityId: "TC-ID-COAL", revenue: 2_080_000_000, fanil: 296_000_000, currentTax: 71_000_000, deferredTax: 2_100_000, otherCovered: 0, nonCovered: 4_800_000, payrollEligible: 62_000_000, employees: 2_900, tangibleEligible: 380_000_000, cbcrRevenue: 2_080_000_000, cbcrProfit: 296_000_000, cbcrTax: 73_100_000, priorDta: 3_200_000, priorDtl: 18_400_000 },
  { entityId: "TC-ID-MINE", revenue: 240_000_000, fanil: 31_000_000, currentTax: 7_400_000, deferredTax: 300_000, otherCovered: 0, nonCovered: 0, payrollEligible: 18_000_000, employees: 1_100, tangibleEligible: 96_000_000, cbcrRevenue: 240_000_000, cbcrProfit: 31_000_000, cbcrTax: 7_700_000, priorDta: 400_000, priorDtl: 2_900_000 },
  { entityId: "TC-AU-COAL", revenue: 684_000_000, fanil: -42_000_000, currentTax: 0, deferredTax: -5_000_000, otherCovered: 0, nonCovered: 0, payrollEligible: 138_000_000, employees: 1_450, tangibleEligible: 410_000_000, cbcrRevenue: 684_000_000, cbcrProfit: -42_000_000, cbcrTax: -5_000_000, priorDta: 21_000_000, priorDtl: 9_000_000 },
  { entityId: "TC-US-GAS", revenue: 720_000_000, fanil: 96_000_000, currentTax: 4_200_000, deferredTax: 16_800_000, otherCovered: 0, nonCovered: 0, payrollEligible: 41_000_000, employees: 380, tangibleEligible: 620_000_000, cbcrRevenue: 720_000_000, cbcrProfit: 96_000_000, cbcrTax: 21_000_000, priorDta: 2_000_000, priorDtl: 58_000_000 },
  { entityId: "TC-US-PWR", revenue: 190_000_000, fanil: 24_000_000, currentTax: 1_800_000, deferredTax: 3_300_000, otherCovered: 0, nonCovered: 0, payrollEligible: 6_000_000, employees: 60, tangibleEligible: 310_000_000, cbcrRevenue: 190_000_000, cbcrProfit: 24_000_000, cbcrTax: 5_100_000, priorDta: 300_000, priorDtl: 14_000_000 },
  { entityId: "TC-JP-PWR", revenue: 48_000_000, fanil: 9_000_000, currentTax: 2_600_000, deferredTax: 200_000, otherCovered: 0, nonCovered: 0, payrollEligible: 2_400_000, employees: 22, tangibleEligible: 84_000_000, cbcrRevenue: 48_000_000, cbcrProfit: 9_000_000, cbcrTax: 2_800_000, priorDta: 100_000, priorDtl: 1_900_000 },
  { entityId: "TC-CN-PWR", revenue: 212_000_000, fanil: 36_000_000, currentTax: 4_600_000, deferredTax: 300_000, otherCovered: 0, nonCovered: 260_000, payrollEligible: 9_000_000, employees: 520, tangibleEligible: 150_000_000, cbcrRevenue: 212_000_000, cbcrProfit: 36_000_000, cbcrTax: 4_900_000, priorDta: 800_000, priorDtl: 2_100_000 },
  ...
  { entityId: "TC-VN-JV", revenue: 96_000_000, fanil: 22_000_000, currentTax: 400_000, deferredTax: 0, otherCovered: 0, nonCovered: 0, payrollEligible: 3_000_000, employees: 45, tangibleEligible: 182_000_000, cbcrRevenue: 96_000_000, cbcrProfit: 22_000_000, cbcrTax: 400_000, priorDta: 100_000, priorDtl: 0 },
...
const adjustments: Adjustment[] = [
  { id: "ADJ-TC-01", entityId: "TC-UPE", category: "Excluded dividends", original: 124_000_000, amount: -124_000_000, reason: "Dividends from PT ThaiCoal Indo Tbk, ThaiCoal Singapore and ThaiCoal Power PCL — ownership ≥ 10%, excluded under Art. 3.2.1(b)", ruleId: "OECD-DIV-EXCL", sourceDoc: "TC001 Trial Balance FY2026.xlsx", account: "810020", preparer: "P. Wongchai", reviewer: "K. Suksawat", status: "Reviewed" },
  { id: "ADJ-TC-02", entityId: "TC-UPE", category: "Net tax expense", original: 10_120_000, amount: -620_000, reason: "Remove signboard tax and local development levies booked in tax expense — not Covered Taxes", ruleId: "OECD-GloBE-15", sourceDoc: "TC tax provision FY2026.xlsx", account: "720050", preparer: "P. Wongchai", reviewer: "K. Suksawat", status: "Reviewed" },
  { id: "ADJ-TC-03", entityId: "TC-TH-PWR", category: "Excluded dividends", original: 59_000_000, amount: -59_000_000, reason: "Dividends from the Japan and China power CEs and the Lao associate — Art. 3.2.1(b); the associate sits outside the GloBE perimeter", ruleId: "OECD-DIV-EXCL", sourceDoc: "TC010 Trial Balance FY2026.xlsx", account: "810020", preparer: "S. Thongdee", reviewer: "K. Suksawat", status: "Reviewed" },
  { id: "ADJ-TC-04", entityId: "TC-SG-REN", category: "Excluded dividends", original: 8_200_000, amount: -8_200_000, reason: "Dividends from Asian solar portfolio companies, ownership ≥ 10%", ruleId: "OECD-DIV-EXCL", sourceDoc: "TC041 TB FY2026.xlsx", account: "810020", preparer: "J. Lim", reviewer: null, status: "Prepared" },
...
const accounts: AccountMap[] = [
  ...
  { account: "810020", name: "Dividend income", entityId: "TC-UPE", financial: "Other income", globe: "Excluded dividends", adjustment: "Art. 3.2.1(b)", confidence: 97, approved: true, amount: 124_000_000 },
...
const issues: Issue[] = [
  ...
  { id: "IQ-04", severity: "warn", area: "CbCR", jurisdiction: "Singapore", title: "CbCR revenue vs consolidation", detail: "Singapore CbCR revenue $1,643.0M vs consolidation $1,640.4M. $2.6M unexplained — intra-group trading eliminations.", owner: "J. Lim" },
  ...
  { id: "IQ-09", severity: "warn", area: "Deferred tax", entity: "TC-US-GAS", jurisdiction: "United States", title: "IDC deferred-tax roll-forward narrative", detail: "Intangible drilling cost DTL movement $16.8M lacks Art. 4.4.5(a) recapture-exception tagging in the register.", owner: "US Tax" },
...
const forecast: GroupSeed["forecast"] = [
  { period: "Q1 actual", topUp: 2_300_000 },
  { period: "Q2 actual", topUp: 2_600_000 },
  { period: "Q3 forecast", topUp: 2_700_000 },
  { period: "Q4 forecast", topUp: 2_600_000 },
];
