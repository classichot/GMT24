...
export const PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    slug: "app-review",
    menu: "App review",
    title: "App reviewer walkthrough",
    summary: "Ingest sample files or the demo close pack, approve mappings, then verify live calculation anchors against the OECD engine.",
