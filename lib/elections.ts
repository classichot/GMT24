...
export const ELECTIONS: ElectionDef[] = [
  ...
  { id: "SETR_SHIP", n: "S4", family: "setr", name: "International Shipping exclusion opt-out", article: "SETR", scope: "JURISDICTION", duration: "five-year", gir: "jurisdictional", girField: "Shipping exclusion opt-out", defaultTx: "Exclude qualifying shipping income", electedTx: "Retain income/tax in Simplified ETR", consistency: "5-year", revocable: true, reelect: "restricted", qdmtt: "n/a", impact: "Shipping groups — Core Art. 3.4 still excludes; this opt-out is SETR only", href: "/globe-income" },
