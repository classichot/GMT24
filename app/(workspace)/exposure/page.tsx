  ...
  return (
    <div>
      <div className="kpi-grid cols-4" style={{ marginBottom: 24 }}>
        ...
        <div className="kpi"><div className="kpi-label">IIR</div><div className="kpi-val">{eur(t.iir, true)}</div><div className="kpi-sub">POPE then UPE</div></div>
      ...
      <div className="panel">
        ...
        <div className="panel-body">
          {hot.map((c) => (
            <div key={c.blendKey} style={{ display: "grid", gridTemplateColumns: "160px 1fr 120px 160px", gap: 12, alignItems: "center", padding: "10px 0", borderBottom: "1px solid var(--color-divider)" }}>
              <div>
