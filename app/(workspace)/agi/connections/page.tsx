  ...
  return (
    <div style={{ display: "grid", gap: 20 }}>
      ...
      <div className="callout">
        <strong>Connecting an external assistant is not the same as selecting a model.</strong> Grok Bot, Claude Cowork and GPT Work are the three clients that can drive a GMT24 mission from outside; each connects to the same Agent Gateway and uses the same tool catalogue, so a mission started in one can be continued in another under the same mission id. Native specialists and external agents share scoped credentials, tenant isolation and an activity log. Retrieved documents are evidence inputs — they cannot expand an agent’s authority. Model choice for GMT24's own Co-Pilot lives in <Link href="/settings">Settings</Link> and is unrelated. Keys are scoped to this group; approval scopes do not exist — agents prepare, people approve in GMT24.
      </div>
