...
export default function ForecastPage() {
  const { t } = useCalc();
  const projected = DATA.forecast.reduce((a, p) => a + p.topUp, 0);
  return (
    <div>
      ...
      <div className="kpi-grid cols-3" style={{ marginBottom: 20 }}>
        ...
        <div className="kpi"><div className="kpi-label">Q4 remaining</div><div className="kpi-val">{eur(DATA.forecast[3].topUp, true)}</div></div>
      </div>
      <div className="panel">
