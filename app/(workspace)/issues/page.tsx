...
export default function IssuesPage() {
  ...
  return (
    <div className="grid-split">
      <div className="panel">
        <div className="panel-head"><h4>Open issues</h4></div>
        {ISSUES.map((i) => (
      ...
      <div className="panel">
        <div className="panel-head"><h4>AI Pillar Two Reviewer</h4><button className="btn btn-secondary" onClick={() => flash("Second-level review re-run")}>Re-run</button></div>
        {reviewer.map((r) => (
